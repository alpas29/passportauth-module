...
namespace Modules\PassportAuth\Http\Controllers\API;

use Illuminate\Auth\Events\Registered;
use Illuminate\Database\Eloquent\Model;
use Modules\PassportAuth\Traits\AuthUser;
use Modules\PassportAuth\Http\Requests\API\RegisterRequest;
use Illuminate\Http\JsonResponse;
use Modules\PassportAuth\Entities\PassportAuthUser;
